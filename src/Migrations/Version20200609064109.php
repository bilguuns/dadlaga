 ...
 */
final class Version20200609064109 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bnr_banner ADD company_id INT DEFAULT NULL, ADD position_id INT DEFAULT NULL, ADD inserted_by_id INT DEFAULT NULL, ADD approved_by_id INT DEFAULT NULL, ADD responded_by_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE bnr_banner DROP company_id, DROP position_id, DROP inserted_by_id, DROP approved_by_id, DROP responded_by_id');
    }
}
